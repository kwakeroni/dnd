...
/*
    This class is copied and adapted to use the file "/META-INF/services-xpp3/org.xmlpull.v1.XmlPullParserFactory" for service resolution.
    This is necessary as the custom service specification format expected by this factory conflicts with the Java 9 module resolution
    if the file is located in the standard "/META-INF/services/" directory.
 */
 ...
 * META-INF/services-xpp3/org.xmlpull.v1.XmlPullParserFactory resource that should contain
...
public class XmlPullParserFactory {
    ...
    private static final String RESOURCE_NAME =
            "/META-INF/services-xpp3/" + PROPERTY_NAME;
