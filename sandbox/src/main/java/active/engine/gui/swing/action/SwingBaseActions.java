...
public class SwingBaseActions {
    ...
    public static Action startFight(GUIController gui) {
        return new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent e) {
                showFight(gui, gui.getBattleField()::startFight);
            }
        };
    }

    public static Action importFight(GUIController gui, Supplier<Component> parent) {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                selectFile()
                        ...
                        .andThen(file -> {
                            ...
                            try {
                                DefaultFight fight = XMLInput.readFight(file);
                                showFight(gui, () -> gui.getBattleField().continueFight(fight));
    ...
    private static void showFight(GUIController gui, Supplier<FightController> fightSupplier) {
        DecoratedDescription.Builder log = log();

        CommandHandler handler = gui.getCommandHandler();
        FightController fight = fightSupplier.get();
